...
const SEO=props=>{const data=(0,gatsby_browser_entry.useStaticQuery)("3268162048");const{siteMetadata}=data.site;const{title,description,url,author,meta=[],keywords=[],image}=siteMetadata;const siteTitle=props.title||title;const siteDescription=props.description||description;const siteUrl=props.url||url;const siteAuthor=props.author||author;const siteImage=props.image||image;const siteKeywords=[...keywords,props.keywords].join(",");const metaData=[{name:"canonical",content:siteUrl},{name:"description",content:siteDescription},{name:"image",content:siteImage},{name:"og:url",content:siteUrl},{name:"og:type",content:"article"},{name:"og:title",content:siteTitle},{name:"og:description",content:siteDescription},{name:"og:image",content:siteImage},{name:"twitter:card",content:"summary_large_image"},{name:"twitter:creator",content:siteAuthor},{name:"twitter:title",content:siteTitle},{name:"twitter:description",content:siteDescription},{name:"twitter:image",content:siteImage},{name:"keywords",content:siteKeywords}].concat(meta);const linkData=[{rel:"shortcut icon",href:"favicon.ico"},{rel:"apple-touch-icon",href:"icons/apple-touch-icon.png"}];return/*#__PURE__*/react.createElement(HelmetExport,{htmlAttributes:{lang:"en"},title:siteTitle// titleTemplate={`%s | ${siteTitle}`}
,meta:metaData,link:linkData});};
;// CONCATENATED MODULE: ./src/components/seo/index.ts

;// CONCATENATED MODULE: ./src/pages/404.tsx
const NotFoundPage=()=>/*#__PURE__*/react.createElement(layout/* Layout */.A,null,/*#__PURE__*/react.createElement(SEO,{title:"404: Not found"}),/*#__PURE__*/react.createElement("h1",null,"Oops! 404"),/*#__PURE__*/react.createElement("h3",null,"You just hit a route that doesn't exist."),/*#__PURE__*/react.createElement(gatsby_browser_entry.Link,{to:"/"},"Go Home"));/* harmony default export */ const _404 = (NotFoundPage);
